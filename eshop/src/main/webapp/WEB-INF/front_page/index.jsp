...
<body>
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="<%=basePath%>res/assert/bg.jpg" alt="..." style="height:600px;width: 1200px;margin-left: 20%;">
				<div class="carousel-caption">这是背景</div>
			</div>
			<div class="item">
				<img src="<%=basePath%>res/assert/logo-2.png" alt="..." style="height:600px;width: 1200px;margin-left: 20%;">
				<div class="carousel-caption">这是logo</div>
			</div>
			<div class="item">
				<img src="<%=basePath%>res/assert/xm5sad.jpg" alt="小米最新款，小米5s，你值得拥有" style="height:600px;width: 1200px;margin-left: 20%;">
				<div class="carousel-caption">这是小米5s</div>
			</div>
		</div>
			<!-- Controls -->
